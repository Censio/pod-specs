Pod::Spec.new do |s|
  ...
  s.name         = 'Pablo'
  s.version      = '3.2.0-preview7-SNAPSHOT'
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/ios-cocoapods-development/Pablo/Pablo-3.2.0-preview7-SNAPSHOT.tar.gz' }
