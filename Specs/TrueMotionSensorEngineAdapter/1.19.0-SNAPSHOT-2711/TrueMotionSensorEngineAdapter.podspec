Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineAdapter/TrueMotionSensorEngineAdapter-1.19.0-SNAPSHOT-2711.tar.gz" }
	spec.vendored_frameworks = "TrueMotionSensorEngineAdapter.xcframework"
