Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineAdapter/TrueMotionSensorEngineAdapter-1.1.0-SNAPSHOT-2117.tar.gz" }
