Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-2136"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineAdapter/TrueMotionSensorEngineAdapter-1.1.0-SNAPSHOT-2136.tar.gz" }
