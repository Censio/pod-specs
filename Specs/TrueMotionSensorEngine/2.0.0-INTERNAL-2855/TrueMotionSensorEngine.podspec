Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TrueMotionSensorEngine/2.0.0-INTERNAL-2855/TrueMotionSensorEngine-2.0.0-INTERNAL-2855.zip' }
