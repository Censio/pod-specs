Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TrueMotionSensorEngine/2.0.0-INTERNAL-2854/TrueMotionSensorEngine-2.0.0-INTERNAL-2854.zip' }
  ...
  s.dependency "TrueMotionCore", '~> 6.0'
  s.dependency "TrueMotionInternal", '~> 6.0'
