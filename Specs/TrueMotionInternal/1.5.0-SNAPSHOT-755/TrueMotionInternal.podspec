Pod::Spec.new do |spec|
	...
	spec.version = "1.5.0-SNAPSHOT-755"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionInternal/TrueMotionInternal-1.5.0-SNAPSHOT-755.tar.gz" }
