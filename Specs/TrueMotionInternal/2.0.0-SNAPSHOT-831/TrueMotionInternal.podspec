Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-831"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionInternal/TrueMotionInternal-2.0.0-SNAPSHOT-831.tar.gz" }
