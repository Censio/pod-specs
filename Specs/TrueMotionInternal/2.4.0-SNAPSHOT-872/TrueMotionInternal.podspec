Pod::Spec.new do |spec|
	...
	spec.version = "2.4.0-SNAPSHOT-872"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionInternal/TrueMotionInternal-2.4.0-SNAPSHOT-872.tar.gz" }
