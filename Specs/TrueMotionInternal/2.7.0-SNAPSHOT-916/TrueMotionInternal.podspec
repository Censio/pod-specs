Pod::Spec.new do |spec|
	...
	spec.version = "2.7.0-SNAPSHOT-916"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionInternal/TrueMotionInternal-2.7.0-SNAPSHOT-916.tar.gz" }
