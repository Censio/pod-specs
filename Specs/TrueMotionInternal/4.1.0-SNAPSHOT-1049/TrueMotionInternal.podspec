Pod::Spec.new do |spec|
	...
	spec.version = "4.1.0-SNAPSHOT-1049"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionInternal/TrueMotionInternal-4.1.0-SNAPSHOT-1049.tar.gz" }
