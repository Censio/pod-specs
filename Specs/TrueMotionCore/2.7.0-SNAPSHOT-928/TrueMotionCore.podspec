Pod::Spec.new do |spec|
	...
	spec.version = "2.7.0-SNAPSHOT-928"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-2.7.0-SNAPSHOT-928.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 6.0'
        spec.dependency 'TrueMotionInternal', '2.7.0-SNAPSHOT-928'
