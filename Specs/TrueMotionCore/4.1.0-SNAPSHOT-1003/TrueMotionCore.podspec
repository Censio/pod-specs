Pod::Spec.new do |spec|
	...
	spec.version = "4.1.0-SNAPSHOT-1003"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-4.1.0-SNAPSHOT-1003.tar.gz" }
