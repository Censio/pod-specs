Pod::Spec.new do |spec|
    ...
    spec.version = "1.0.0-feature-podspec-dependencies"
  ...
  TrueMotion Core SDK provides functionality to networking, session handling and logging.
    ...
    spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.0.0-feature-podspec-dependencies.tar.gz" }
