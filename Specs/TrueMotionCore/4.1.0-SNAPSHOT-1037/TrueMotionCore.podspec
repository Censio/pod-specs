Pod::Spec.new do |spec|
	...
	spec.version = "4.1.0-SNAPSHOT-1037"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-4.1.0-SNAPSHOT-1037.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '4.1.0-SNAPSHOT-1037'
