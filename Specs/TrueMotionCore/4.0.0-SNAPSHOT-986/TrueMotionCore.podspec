Pod::Spec.new do |spec|
	...
	spec.version = "4.0.0-SNAPSHOT-986"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-4.0.0-SNAPSHOT-986.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
        spec.dependency 'TrueMotionInternal', '4.0.0-SNAPSHOT-986'
