Pod::Spec.new do |spec|
	...
	spec.version = "5.1.0-SNAPSHOT-1127"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-5.1.0-SNAPSHOT-1127.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '5.1.0-SNAPSHOT-1127'
end