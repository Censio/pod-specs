Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-834"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-2.0.0-SNAPSHOT-834.tar.gz" }
