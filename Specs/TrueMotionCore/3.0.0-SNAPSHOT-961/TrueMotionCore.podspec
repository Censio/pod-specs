Pod::Spec.new do |spec|
	...
	spec.version = "3.0.0-SNAPSHOT-961"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-3.0.0-SNAPSHOT-961.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '3.0.0-SNAPSHOT-961'
