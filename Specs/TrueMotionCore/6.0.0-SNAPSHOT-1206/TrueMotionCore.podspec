Pod::Spec.new do |spec|
	...
	spec.version = "6.0.0-SNAPSHOT-1206"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-6.0.0-SNAPSHOT-1206.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '6.0.0-SNAPSHOT-1206'
end