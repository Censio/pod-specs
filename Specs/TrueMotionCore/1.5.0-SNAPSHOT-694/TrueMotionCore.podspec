Pod::Spec.new do |spec|
	...
	spec.version = "1.5.0-SNAPSHOT-694"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.5.0-SNAPSHOT-694.tar.gz" }
