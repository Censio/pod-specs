Pod::Spec.new do |spec|
	...
	spec.version = "1.5.0-SNAPSHOT-702"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.5.0-SNAPSHOT-702.tar.gz" }
