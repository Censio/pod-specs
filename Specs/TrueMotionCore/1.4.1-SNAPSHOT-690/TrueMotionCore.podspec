Pod::Spec.new do |spec|
	...
	spec.version = "1.4.1-SNAPSHOT-690"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.4.1-SNAPSHOT-690.tar.gz" }
