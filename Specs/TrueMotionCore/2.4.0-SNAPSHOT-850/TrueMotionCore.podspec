Pod::Spec.new do |spec|
	...
	spec.version = "2.4.0-SNAPSHOT-850"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-2.4.0-SNAPSHOT-850.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '6.0.0-rc.1'
        spec.dependency 'TrueMotionInternal', '2.4.0-SNAPSHOT-850'
