Pod::Spec.new do |spec|
	...
	spec.version = "1.4.1-SNAPSHOT-678"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.4.1-SNAPSHOT-678.tar.gz" }
