Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-803"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-2.0.0-SNAPSHOT-803.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '2.0.0-SNAPSHOT-803'
