Pod::Spec.new do |spec|
	...
	spec.version = "4.0.1-SNAPSHOT-996"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-4.0.1-SNAPSHOT-996.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCore.framework"
	spec.dependency 'RxSwift', '~> 5.0'
        spec.dependency 'TrueMotionInternal', '4.0.1-SNAPSHOT-996'
