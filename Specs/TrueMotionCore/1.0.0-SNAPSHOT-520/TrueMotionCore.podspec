Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-520"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCore/TrueMotionCore-1.0.0-SNAPSHOT-520.tar.gz" }
