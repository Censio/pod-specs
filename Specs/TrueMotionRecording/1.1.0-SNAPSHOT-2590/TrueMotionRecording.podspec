Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-2590"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.1.0-SNAPSHOT-2590.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-2590'
