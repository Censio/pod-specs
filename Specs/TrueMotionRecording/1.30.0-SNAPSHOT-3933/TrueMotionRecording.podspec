Pod::Spec.new do |spec|
	...
	spec.version = "1.30.0-SNAPSHOT-3933"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.30.0-SNAPSHOT-3933.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.30.0-SNAPSHOT-3933'
