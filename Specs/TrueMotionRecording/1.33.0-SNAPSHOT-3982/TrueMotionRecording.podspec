Pod::Spec.new do |spec|
	...
	spec.version = "1.33.0-SNAPSHOT-3982"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.33.0-SNAPSHOT-3982.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.33.0-SNAPSHOT-3982'
