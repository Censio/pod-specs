Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-2396"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.1.0-SNAPSHOT-2396.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
    spec.dependency 'RxSwift', '6.0.0-rc.1'
    spec.dependency 'TrueMotionCore', '2.0.0-SNAPSHOT-834'
    spec.dependency 'TrueMotionInternal', '2.0.0-SNAPSHOT-834'
    spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-2396'
