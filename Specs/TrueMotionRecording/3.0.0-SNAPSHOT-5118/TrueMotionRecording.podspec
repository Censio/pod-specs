Pod::Spec.new do |spec|
	...
	spec.version = "3.0.0-SNAPSHOT-5118"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-3.0.0-SNAPSHOT-5118.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
    spec.dependency 'TrueMotionCommon', '3.0.0-SNAPSHOT-5118'
