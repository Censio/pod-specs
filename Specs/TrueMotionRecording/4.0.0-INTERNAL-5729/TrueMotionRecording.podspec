Pod::Spec.new do |spec|
	...
	spec.version = "4.0.0-INTERNAL-5729"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-4.0.0-INTERNAL-5729.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.xcframework"
    spec.dependency 'TrueMotionCommon', '4.0.0-INTERNAL-5729'
