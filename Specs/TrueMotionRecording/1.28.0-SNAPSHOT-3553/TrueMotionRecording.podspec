Pod::Spec.new do |spec|
	...
	spec.version = "1.28.0-SNAPSHOT-3553"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.28.0-SNAPSHOT-3553.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.28.0-SNAPSHOT-3553'
