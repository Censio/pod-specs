Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-4699"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-2.0.0-SNAPSHOT-4699.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
    spec.dependency 'TrueMotionCommon', '2.0.0-SNAPSHOT-4699'
