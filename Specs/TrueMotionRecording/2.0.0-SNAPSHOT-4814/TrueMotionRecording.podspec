Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-4814"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-2.0.0-SNAPSHOT-4814.tar.gz" }
