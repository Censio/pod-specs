Pod::Spec.new do |spec|
	...
	spec.version = "1.29.0-SNAPSHOT-3670"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.29.0-SNAPSHOT-3670.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.29.0-SNAPSHOT-3670'
