Pod::Spec.new do |spec|
	...
	spec.version = "1.19.0-SNAPSHOT-2697"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.19.0-SNAPSHOT-2697.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.19.0-SNAPSHOT-2697'
