Pod::Spec.new do |spec|
	...
	spec.version = "1.30.0-SNAPSHOT-3943"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.30.0-SNAPSHOT-3943.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
    spec.dependency 'TrueMotionCore', '~> 2.9'
    spec.dependency 'TrueMotionInternal', '~> 2.9'
    spec.dependency 'TrueMotionCommon', '1.30.0-SNAPSHOT-3943'
