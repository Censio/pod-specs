Pod::Spec.new do |spec|
	...
	spec.version = "1.25.1-SNAPSHOT-3681"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.25.1-SNAPSHOT-3681.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.25.1-SNAPSHOT-3681'
