Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-2.0.0-SNAPSHOT-4958.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.xcframework"
    spec.dependency 'TrueMotionCommon', '2.0.0-SNAPSHOT-4958'
    spec.dependency 'TrueMotionSensorEngineInterface', '2.0.0-SNAPSHOT-4958'
end