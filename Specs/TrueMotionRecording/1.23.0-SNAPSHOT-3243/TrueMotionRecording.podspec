Pod::Spec.new do |spec|
	...
	spec.version = "1.23.0-SNAPSHOT-3243"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.23.0-SNAPSHOT-3243.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.23.0-SNAPSHOT-3243'
