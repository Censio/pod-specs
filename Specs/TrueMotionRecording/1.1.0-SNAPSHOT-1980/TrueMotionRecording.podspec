Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-1980"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.1.0-SNAPSHOT-1980.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
	spec.dependency 'TrueMotionCore', '~> 1.0'
	spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-1980'
end