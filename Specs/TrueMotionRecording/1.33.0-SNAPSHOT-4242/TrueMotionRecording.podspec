Pod::Spec.new do |spec|
	...
	spec.version = "1.33.0-SNAPSHOT-4242"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.33.0-SNAPSHOT-4242.tar.gz" }
	spec.vendored_frameworks = "TrueMotionRecording.framework"
    spec.dependency 'TrueMotionCommon', '1.33.0-SNAPSHOT-4242'
