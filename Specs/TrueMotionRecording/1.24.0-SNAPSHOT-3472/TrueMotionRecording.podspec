Pod::Spec.new do |spec|
	...
	spec.version = "1.24.0-SNAPSHOT-3472"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.24.0-SNAPSHOT-3472.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.24.0-SNAPSHOT-3472'
