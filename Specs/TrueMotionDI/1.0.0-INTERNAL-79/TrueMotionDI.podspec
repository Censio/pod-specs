Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TrueMotionDI/1.0.0-INTERNAL-79/TrueMotionDI-1.0.0-INTERNAL-79.zip' }
