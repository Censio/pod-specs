Pod::Spec.new do |s|
  ...
  s.version      = "1.0.24.mobile-api-integration"
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-1.0.24.mobile-api-integration.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMotionCommon', '1.33.0-SNAPSHOT-4130'
  s.dependency 'TrueMotionCrash', '1.33.0-SNAPSHOT-4130'
  s.dependency 'TrueMotionRecording', '1.33.0-SNAPSHOT-4130'
  s.dependency 'TrueMotionCore', '3.0.0'
