Pod::Spec.new do |s|
  ...
  s.version      = "1.0.14.mobile-api-integration"
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-1.0.14.mobile-api-integration.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMotionCommon', '1.21.0'
  s.dependency 'TrueMotionCrash', '1.21.0'
  s.dependency 'TrueMotionRecording', '1.21.0'
  s.dependency 'TrueMotionCore', '2.5.0'
  s.dependency 'CensioKit', '5.3.0'
