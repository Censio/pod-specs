Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-5.0.0.7832.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMotionCommon', '~> 3.0'
  s.dependency 'TrueMotionCrash', '~> 3.0'
  s.dependency 'TrueMotionRecording', '~> 3.0'
