Pod::Spec.new do |s|
  ...
  s.version      = "1.0.19.mobile-api-integration"
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-1.0.19.mobile-api-integration.zip' }
