Pod::Spec.new do |s|
  ...
  s.version      = "1.0.5.mobile-api-integration.7396"
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-1.0.5.mobile-api-integration.7396.zip' }
