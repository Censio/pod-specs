Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-3.0.1.7697.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMobileCoreSDK', "3.0.3"
