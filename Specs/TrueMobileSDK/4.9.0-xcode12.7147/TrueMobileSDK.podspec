Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "11.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-4.9.0-xcode12.7147.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMobileCoreSDK', "4.2.0-xcode12"
