Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "12.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMobileSDK/TrueMobileSDK-4.11.4.7231.zip' }
  ...
  # TrueMotion
  s.dependency 'TrueMobileCoreSDK', "4.3.0"
