Pod::Spec.new do |s|
  s.name         = "RecordingSDK"
  s.version      = "0.11.0.develop-22aeedb"
  ...
  s.source       = { :http => 'https://censiodev.artifactoryonline.com/censiodev/cocoapods-local/RecordingSDK/RecordingSDK-develop-22aeedb.zip' }
