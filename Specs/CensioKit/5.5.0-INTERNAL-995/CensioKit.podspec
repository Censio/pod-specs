Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.5.0-INTERNAL-995.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '3.1.0-SNAPSHOT-972'
