Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.6.0-INTERNAL-1008.tar.gz" }
  ...
  s.dependency 'TrueMotionSensorEngineInterface'
end
