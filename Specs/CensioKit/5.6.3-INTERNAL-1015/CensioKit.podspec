Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.6.3-INTERNAL-1015.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '4.3.0-SNAPSHOT-1121'
