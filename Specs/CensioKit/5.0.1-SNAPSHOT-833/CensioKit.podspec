Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.0.1-SNAPSHOT-833.tar.gz" }
  ...
  s.dependency 'TrueMotionSensorEngineAdapter', '~> 1.10'
  s.dependency 'Pablo', '~> 2.6.0'
end