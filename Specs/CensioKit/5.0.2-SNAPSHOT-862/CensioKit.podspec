Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.0.2-SNAPSHOT-862.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '2.0.0-SNAPSHOT-769'
