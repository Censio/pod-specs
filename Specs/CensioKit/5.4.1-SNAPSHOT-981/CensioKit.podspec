Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.4.1-SNAPSHOT-981.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '2.7.0-SNAPSHOT-934'
  s.dependency 'TrueMotionSensorEngineAdapter', '1.30.0-SNAPSHOT-3803'
end
