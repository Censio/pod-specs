Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.0.0-SNAPSHOT-798.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '>= 1.5'
  s.dependency 'TrueMotionSensorEngineAdapter', '1.1.0-SNAPSHOT-1632'
end