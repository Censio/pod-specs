Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censiodev.jfrog.io/artifactory/cocoapods-local/CensioKit/CensioKit-5.6.3-INTERNAL-1023.tar.gz" }
  ...
  s.dependency 'TrueMotionSensorEngineInterface', '4.0.0-SNAPSHOT-94'
end
