Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1.438-dev+c9ea93e
"
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TMOSensorEngine/0.0.1.438-dev/TMOSensorEngineQA/TMOSensorEngineQA-0.0.1.438-dev.zip' }
