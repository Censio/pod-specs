Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.1.0-INTERNAL-2350/TMOSensorEngineQA-1.1.0-INTERNAL-2350.zip' }
