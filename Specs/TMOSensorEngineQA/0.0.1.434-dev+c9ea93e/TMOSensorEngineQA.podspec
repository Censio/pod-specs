Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1.434-dev+c9ea93e
"
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TMOSensorEngine/0.0.1.434-dev/TMOSensorEngineQA/TMOSensorEngineQA-0.0.1.434-dev.zip' }
