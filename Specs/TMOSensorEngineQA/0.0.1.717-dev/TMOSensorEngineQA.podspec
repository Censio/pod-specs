Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/censiodev/cocoapods-local/TMOSensorEngine/0.0.1.717-dev/TMOSensorEngineQA/TMOSensorEngineQA-0.0.1.717-dev.zip' }
