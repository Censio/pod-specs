Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.1.0-SNAPSHOT-1500/TMOSensorEngineQA-1.1.0-SNAPSHOT-1500.zip' }
