Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.0.1-SNAPSHOT-1345/TMOSensorEngineQA-1.0.1-SNAPSHOT-1345.zip' }
