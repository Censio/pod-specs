Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.0.0-SNAPSHOT-1117/TMOSensorEngineQA/TMOSensorEngineQA-1.0.0-SNAPSHOT-1117.zip' }
