Pod::Spec.new do |spec|
    ...
    spec.version = "1.0.0-ci-reset-build-settings"
  ...
  TrueMotion Common SDK provides functionality to the common parts of TrueMotion API.
    ...
    spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.0.0-ci-reset-build-settings.tar.gz" }
