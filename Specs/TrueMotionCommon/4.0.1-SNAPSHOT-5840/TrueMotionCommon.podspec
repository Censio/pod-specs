Pod::Spec.new do |spec|
	...
	spec.version = "4.0.1-SNAPSHOT-5840"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-4.0.1-SNAPSHOT-5840.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCommon.framework"
    spec.dependency 'RealmSwift', '~> 10.1'
    spec.dependency 'Realm', '~> 10.1'
    spec.dependency 'TrueMotionCore', '5.2.1'
    spec.dependency 'TrueMotionInternal', '5.2.1'
end