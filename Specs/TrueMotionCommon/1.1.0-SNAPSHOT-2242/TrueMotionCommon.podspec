Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-2242"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.1.0-SNAPSHOT-2242.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCommon.framework"
        spec.dependency 'TrueMotionInternal', '2.0.0-SNAPSHOT-832'
	spec.dependency 'TrueMotionCore', '2.0.0-SNAPSHOT-832'
	spec.dependency 'RxSwift', '6.0.0-rc.1'
        spec.dependency 'Realm', '10.1.1'
