Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-4711"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-2.0.0-SNAPSHOT-4711.tar.gz" }
