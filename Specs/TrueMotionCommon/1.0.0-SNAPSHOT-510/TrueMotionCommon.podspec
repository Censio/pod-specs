Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-510"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.0.0-SNAPSHOT-510.tar.gz" }
