Pod::Spec.new do |spec|
	...
	spec.version = "3.0.0-SNAPSHOT-5009"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-3.0.0-SNAPSHOT-5009.tar.gz" }
