Pod::Spec.new do |spec|
	...
	spec.version = "2.0.1-SNAPSHOT-4909"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-2.0.1-SNAPSHOT-4909.tar.gz" }
