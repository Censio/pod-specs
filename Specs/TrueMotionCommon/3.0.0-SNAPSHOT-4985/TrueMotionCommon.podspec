Pod::Spec.new do |spec|
	...
	spec.version = "3.0.0-SNAPSHOT-4985"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-3.0.0-SNAPSHOT-4985.tar.gz" }
