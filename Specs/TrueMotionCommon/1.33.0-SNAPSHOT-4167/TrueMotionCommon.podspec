Pod::Spec.new do |spec|
	...
	spec.version = "1.33.0-SNAPSHOT-4167"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.33.0-SNAPSHOT-4167.tar.gz" }
