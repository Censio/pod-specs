Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-2.0.0-SNAPSHOT-4958.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCommon.xcframework"
    spec.dependency 'RealmSwift', '~> 10.1'
    spec.dependency 'Realm', '~> 10.1'
    spec.dependency 'TrueMotionCore', '2.0.0-SNAPSHOT-4958'
