Pod::Spec.new do |spec|
	...
	spec.version = "1.33.0-SNAPSHOT-4289"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.33.0-SNAPSHOT-4289.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCommon.framework"
    spec.dependency 'RealmSwift', '~> 10.1'
    spec.dependency 'Realm', '~> 10.1'
    spec.dependency 'TrueMotionCore', '~> 4.1.0-SNAPSHOT-1003'
    spec.dependency 'TrueMotionInternal', '~> 4.1.0-SNAPSHOT-1003'
end