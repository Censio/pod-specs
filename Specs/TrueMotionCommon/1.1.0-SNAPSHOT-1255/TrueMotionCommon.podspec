Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-1255"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCommon/TrueMotionCommon-1.1.0-SNAPSHOT-1255.tar.gz" }
