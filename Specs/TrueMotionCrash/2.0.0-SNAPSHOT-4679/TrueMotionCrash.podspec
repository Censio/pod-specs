Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-4679"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-2.0.0-SNAPSHOT-4679.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
    spec.dependency 'TrueMotionSensorEngineInterface', '~> 2.0'
    spec.dependency 'TrueMotionCommon', '2.0.0-SNAPSHOT-4679'
end