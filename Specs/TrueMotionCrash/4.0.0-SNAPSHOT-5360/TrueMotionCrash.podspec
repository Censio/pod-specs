Pod::Spec.new do |spec|
	...
	spec.version = "4.0.0-SNAPSHOT-5360"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-4.0.0-SNAPSHOT-5360.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
    spec.dependency 'TrueMotionSensorEngineInterface', '~> 3.0'
    spec.dependency 'TrueMotionCommon', '4.0.0-SNAPSHOT-5360'
end