Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-2116"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.1.0-SNAPSHOT-2116.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
	spec.dependency 'TrueMotionCore', '2.0.0-SNAPSHOT-769'
	spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-2116'
end