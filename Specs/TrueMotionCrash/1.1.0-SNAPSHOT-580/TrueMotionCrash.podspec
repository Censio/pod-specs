Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-580"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.1.0-SNAPSHOT-580.tar.gz" }
