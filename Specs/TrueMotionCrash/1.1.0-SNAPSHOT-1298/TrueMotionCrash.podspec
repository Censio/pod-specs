Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-1298"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.1.0-SNAPSHOT-1298.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
	spec.dependency 'TrueMotionCore', '1.4.1'
	spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-1298'
end