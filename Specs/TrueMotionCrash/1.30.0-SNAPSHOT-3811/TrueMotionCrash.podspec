Pod::Spec.new do |spec|
	...
	spec.version = "1.30.0-SNAPSHOT-3811"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.30.0-SNAPSHOT-3811.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.30.0-SNAPSHOT-3811'
end