Pod::Spec.new do |spec|
	...
	spec.version = "1.33.0-SNAPSHOT-4208"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.33.0-SNAPSHOT-4208.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
    spec.dependency 'TrueMotionSensorEngineInterface', '~> 2.0'
    spec.dependency 'TrueMotionCommon', '1.33.0-SNAPSHOT-4208'
end