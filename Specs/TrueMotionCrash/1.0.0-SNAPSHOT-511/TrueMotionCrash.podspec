Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-511"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.0.0-SNAPSHOT-511.tar.gz" }
