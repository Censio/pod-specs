Pod::Spec.new do |spec|
	...
	spec.version = "1.24.0-SNAPSHOT-3380"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.24.0-SNAPSHOT-3380.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.24.0-SNAPSHOT-3380'
end