Pod::Spec.new do |spec|
	...
	spec.version = "1.24.0-SNAPSHOT-3379"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.24.0-SNAPSHOT-3379.tar.gz" }
    ...
    spec.dependency 'TrueMotionCommon', '1.24.0-SNAPSHOT-3379'
end