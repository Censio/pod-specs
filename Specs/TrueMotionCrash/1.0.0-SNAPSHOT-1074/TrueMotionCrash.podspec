Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-1074"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.0.0-SNAPSHOT-1074.tar.gz" }
	...
	spec.dependency 'TrueMotionCommon', '1.0.0-SNAPSHOT-1074'
end