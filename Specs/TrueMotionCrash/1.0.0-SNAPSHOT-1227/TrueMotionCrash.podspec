Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-1227"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.0.0-SNAPSHOT-1227.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
	spec.dependency 'TrueMotionCore', '1.4.0'
	spec.dependency 'TrueMotionCommon', '1.0.0-SNAPSHOT-1227'
end