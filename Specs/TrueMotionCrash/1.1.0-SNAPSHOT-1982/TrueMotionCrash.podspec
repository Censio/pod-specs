Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-1982"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionCrash/TrueMotionCrash-1.1.0-SNAPSHOT-1982.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
	spec.dependency 'TrueMotionCore', '~> 1.0'
	spec.dependency 'TrueMotionCommon', '1.1.0-SNAPSHOT-1982'
end