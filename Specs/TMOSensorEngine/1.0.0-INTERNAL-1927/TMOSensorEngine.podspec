Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.0.0-INTERNAL-1927/TMOSensorEngine-1.0.0-INTERNAL-1927.zip' }
