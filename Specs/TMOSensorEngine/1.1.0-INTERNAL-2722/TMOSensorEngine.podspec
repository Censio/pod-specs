Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.1.0-INTERNAL-2722/TMOSensorEngine-1.1.0-INTERNAL-2722.zip' }
  ...
  s.dependency "TrueMotionInternal", '~> 5.0'
  s.dependency "TrueMotionSensorEngineInterface", '~> 3.1'
end
