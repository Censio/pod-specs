Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.1.0-INTERNAL-2718/TMOSensorEngine-1.1.0-INTERNAL-2718.zip' }
  ...
  s.dependency "TrueMotionDI", '~> 1.0'
  s.dependency "TrueMotionCore", '~> 5.1.0-SNAPSHOT-1140'
  s.dependency "TrueMotionInternal", '~> 5.1.0-SNAPSHOT-1140'
