Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/1.0.0-SNAPSHOT-1228/TMOSensorEngine-1.0.0-SNAPSHOT-1228.zip' }
