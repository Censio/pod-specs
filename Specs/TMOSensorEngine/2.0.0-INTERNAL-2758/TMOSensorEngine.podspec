Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://censiodev.jfrog.io/artifactory/cocoapods-local/TMOSensorEngine/2.0.0-INTERNAL-2758/TMOSensorEngine-2.0.0-INTERNAL-2758.zip' }
