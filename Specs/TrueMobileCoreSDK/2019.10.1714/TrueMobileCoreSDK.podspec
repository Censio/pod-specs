Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "10.0"
  s.requires_arc = true
  s.source       = { :http => 'https://censiodev.artifactoryonline.com/censiodev/cocoapods-local/TrueMobileCoreSDK/TrueMobileCoreSDK-2019.10.1714.zip' }
