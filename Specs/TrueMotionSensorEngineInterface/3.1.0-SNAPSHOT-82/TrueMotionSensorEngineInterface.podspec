Pod::Spec.new do |spec|
	...
	spec.version = "3.1.0-SNAPSHOT-82"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineInterface/TrueMotionSensorEngineInterface-3.1.0-SNAPSHOT-82.tar.gz" }
