Pod::Spec.new do |spec|
	...
	spec.version = "4.0.0-SNAPSHOT-94"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineInterface/TrueMotionSensorEngineInterface-4.0.0-SNAPSHOT-94.tar.gz" }
