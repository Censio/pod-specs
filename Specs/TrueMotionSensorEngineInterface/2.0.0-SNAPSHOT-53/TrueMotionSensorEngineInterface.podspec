Pod::Spec.new do |spec|
	...
	spec.version = "2.0.0-SNAPSHOT-53"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineInterface/TrueMotionSensorEngineInterface-2.0.0-SNAPSHOT-53.tar.gz" }
