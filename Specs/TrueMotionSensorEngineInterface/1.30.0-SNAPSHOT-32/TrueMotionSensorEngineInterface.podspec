Pod::Spec.new do |spec|
	...
	spec.version = "1.30.0-SNAPSHOT-32"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionSensorEngineInterface/TrueMotionSensorEngineInterface-1.30.0-SNAPSHOT-32.tar.gz" }
