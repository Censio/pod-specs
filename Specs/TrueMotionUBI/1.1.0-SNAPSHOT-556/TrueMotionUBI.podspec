Pod::Spec.new do |spec|
	...
	spec.version = "1.1.0-SNAPSHOT-556"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionUBI/TrueMotionUBI-1.1.0-SNAPSHOT-556.tar.gz" }
