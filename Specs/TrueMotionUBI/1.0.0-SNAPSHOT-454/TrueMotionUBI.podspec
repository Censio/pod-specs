Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-454"
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionUBI/TrueMotionUBI-1.0.0-SNAPSHOT-454.tar.gz" }
