Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionUBI/TrueMotionUBI-2.0.0-SNAPSHOT-4873.tar.gz" }
	spec.vendored_frameworks = "TrueMotionUBI.xcframework"
  spec.dependency 'TrueMotionCommon', '2.0.0-SNAPSHOT-4873'
end